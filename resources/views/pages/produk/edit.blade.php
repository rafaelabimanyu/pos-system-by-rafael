...
<div class="max-w-2xl">
    <x-card title="Informasi Produk" icon="package">
        <form action="{{ route('produk.update', $product) }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            @csrf
            @method('PUT')
            ...
            <div x-data="{ preview: '{{ $product->gambar ? asset('storage/' . $product->gambar) : '' }}' }">
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-xs text-slate-500 mt-1.5">Biarkan kosong jika tidak ingin mengubah gambar.</p>
